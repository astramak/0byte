...
<div class='cbottom'>
    ...
    <form style='display: inline;' method='POST' action='work/rmcom/'><label class='supragrey'><input type='image' name='id' value='<?php echo $comment->id; ?>' src="style/n_img/trash_t.gif" />Удалить</label></form>
    {/allow_delete}
</div>
{/loged}
