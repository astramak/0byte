...
<div class='bottom'>
    <?php if ($loged) { if ($allow_edit) { ?>
       <a href="work/editpost/<?php echo $id; ?>" class='om'><img src="style/n_img/pen.gif"/>Править</a>  
    <?php }
    if ($allow_remove) { ?>
    ...
    if ($allow_spy) {?>
        <a id='sled' class='om' href='<?php echo $spy_url; ?>'><img src="style/n_img/eye.gif"/><?php if ($spyed) {
            echo "Перестать о";
        } else {
            echo "О";
        }
