<div class="usln">
	<div class="usrd">
		...
		</span><?php if ($allow_post) { ?><a href='work/newpost'>Новый пост</a>
			<?php } if ($allow_blog) {?> / <a href='work/newblog'>блог</a><?php }?>. Ваши <a href='work/myblog'>блоги</a> и
		 <!-- <img src='style/img/<?php if ($not_readed>0) {?>mail<?php } else {?>envelope<?php }?>.gif'
