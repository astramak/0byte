...
$tpl->compile_dir="tmp/templ_c";
$tpl->cache_dir="tmp/templ_cache";
$loged=login();
if ($loged==1) {
...
<link rel="search" type="application/opensearchdescription+xml" href="opensearch.php" title="<?php echo $sl_name; ?>" />
